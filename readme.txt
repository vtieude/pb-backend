...
goose migrate db (go install github.com/pressly/goose/v3/cmd/goose@latest)
...
-----------------------
goose -dir db/migrations mysql "root:qweqwe@tcp(localhost:3306)/testSchema?parseTime=true" up  
